...
if ($send2 == "  ok  ") {
  ...
  if ($conn==FALSE) {
      die("<BR>ERROR: Impossible de se connecter à la base de donnée<BR>" );
  }
				...
				<td>
					<FORM NAME="dobackup" METHOD="post" ACTION="backup.php">
						<center>
							<TABLE class="action" >
							  <TR> 
								<h1>Créer une sauvegarde ce la base de donnée</h1>
								...
								<td  class="texte0" colspan="2"height="35" >Les tables à sauvegarder<br>
								  </TD>
				...
				<td>
					<FORM NAME="dodelete" METHOD="post" ACTION="delete.php">
						<center>
							<TABLE class="action">
								<tr>
									<h1>Effacer la sauvegarde de la base de donnée qui reste sur le serveur</h1></td>
								</tr>
								<tr> 
				...
				<td>
					<FORM NAME="dodownload" METHOD="post" ACTION="download.php" TARGET="_blanck">
						<CENTER>
							<TABLE class="action">
								<tr> 
								  <h1>Télécharger la base de donnée</h1>
								</tr>
								<tr> 
