...
<!-- Formulaire pour les enregistrements le jour du spectacle-->
					<td>
						<form name="formu" method="post" action="bon_soir.php" onSubmit="return verif_formulaire()">
							<table>
								...
								<tr><td>
									<SELECT name='num'>
										<OPTION VALUE="">Choisissez le spectacle</OPTION>
											<?php
											$rqSql_article = "SELECT num, article, DATE_FORMAT( date_spectacle, '%d/%m/%Y' ) AS date 
