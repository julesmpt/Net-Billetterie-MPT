 ...
 *  @version    2.0.3 (last revision: July 13, 2012)
...
class Zebra_Session
{
     ...
     *  @return void
     */
    function Zebra_Session($session_lifetime = 6000, $gc_probability = '', $gc_divisor = '', $security_code = 'sEcUr1tY_c0dE', $table_name = 'session_data', $lock_timeout = 60, $link = '')
    {
