...
$sql = "SELECT * FROM " . $tblpref ."enregistrement_caisse
	WHERE date BETWEEN '$annee_2-$debut_saison' AND '$annee_1-$fin_saison' AND libelle='bar' ";
...
<table border="0" class="page" align="center">
	<tr>
		<td class="page" align="center">
		    	<h3>Liste des différents enregistrements de caisse journalière du<FONT size="5em" color="#1C731C"> bar</FONT></h3>
			<?php if ($user_admin != 'n'){?>
			<SCRIPT LANGUAGE="JavaScript">
				...
				<?php } ?>
			 <hr>
			La caisse "bar" est actuellement de <FONT face="Comic Sans MS" color="red"><?php echo "$total_caisse $devise"; ?></FONT>
			Avec <hr>
			<?php
			//On montre ce qu'il y a dans la caissse à ce moment 
				if($pos!="0"){
					$sql2 = "SELECT
							...
							AND ".$tblpref."enregistrement_caisse.libelle='bar'
							group by espece";
