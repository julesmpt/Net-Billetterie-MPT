...
<table class="page">
	<tr>
		<td>
			<CENTER>
				<table class="action">
					<h1>Sauvegarde de la base de donnée</h1>
					<TR> 
						<td class="texte0" height="215" valign="top"> 
							<b><font color="#990000"><?php echo "$lang_back_ok" ?></font></b> 
							<br>Si vous n'avez reçu aucune erreur sur cette page, vous trouverer le backup dans le répertoire 'dump' (sans les guillemets) dans le répertoire d'installation? 
							...
							<br>Ce fichier ne peut être restauré que grâce à l'utilitaire de restauration du logiciel.
							<br>La base de donnée doit avoir le meme nom.
							<br>N'oubliez pas d'effacer ce backup apres l'avoir téléchargé. Laisser un backup sur le serveur est un risque potentiel pour la sécurité.
							<br>
							</font> 
						</TD>
					</TR>
