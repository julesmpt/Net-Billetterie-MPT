...
<br/><br/><br/>
        <h2>Chiffre d'affaires par spectacle de la saison <?php echo "$annee_2 - $annee_1"; ?></h2>
...
//==================================================
                        ...
                        $art = stripcslashes($data['article']);
                        $quanti = $data['nombre'];
			   ...
			   <?php
						$sql5="SELECT SUM( tot_tva ) total FROM `".$tblpref."bon_comm` BC
						WHERE BC.attente='0'
                        AND BC.fact='ok'
